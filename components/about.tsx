        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <motion.div style={{ y, opacity }} className="space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              I'm a dedicated Bachelor of Computer Science student at the
            ...
            <p className="text-lg leading-relaxed">
              When I'm not coding, I enjoy writing novels, which helps me
              exercise my creativity in a different medium.
            </p>
          </motion.div>
