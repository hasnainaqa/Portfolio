...
const projects = [
  ...
  },
  {
    ...
    contribution:
      "Led the frontend development using React.js and Next.js, creating responsive and interactive dashboards. Implemented RESTful APIs for efficient data handling and real-time analytics updates. Integrated advanced charting libraries for data visualization.",
    challenges:
      "Overcame challenges in processing and visualizing large datasets in real-time, optimizing performance for seamless user experience.",
    outcome:
