      ...
      <main className="flex-grow">
        <section className="py-24 relative overflow-hidden themed-section">
          <div className="container px-4 md:px-6">
            ...
            >
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">My Skills</h1>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Explore the technologies and tools I've mastered on my journey as a full-stack developer
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                In the ever-evolving world of web development, I'm committed to continuous learning and improvement. I'm
                always exploring new technologies and best practices to enhance my skill set and deliver cutting-edge
                solutions.
              </p>
